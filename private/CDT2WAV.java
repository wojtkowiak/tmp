package com.tape;
import com.tape.Util;
import com.omegait.cdt.MyActivity;
...
public class CDT2WAV {
	...
	*/
    ...
    public void set(byte[] input, int freq) {
        inpbuf = input;
        frequency = freq;
    }
    ...
    private void convertPass(CDT2WAVBaseOutput output) {
        ...
        while (currentBlock < numBlocks) {
            ...
            if (debug)
                System.out.println("Block: " + getBlock(currentBlock) + " - ID: " + getID(id));
            if (debug)
     ...
     */
    public byte[] convert(MyActivity.PrepareWavTask task) {
        // Sanity checks
        // ...check input and output
        if (inpbuf == null || inpbuf.length < 10) {
            System.out.println("ERR_ILLEGAL_ARGUMENT") ;
    ...
    public String getID(int id){
        ...
        {
            switch (id){
                case 0x10: ret = "Standard Data block"; break;
                case 0x11: ret = "Data block"; break;
                case 0x12: ret = "Pure tone"; break;
                case 0x13: ret = "Pulse sequence"; break;
                case 0x14: ret = "Pure Data"; break;
                case 0x15: ret = "Direct recording"; break;
                case 0x20: ret = "Pause"; break;
                case 0x21: ret = "Group Start"; break;
                case 0x22: ret = "Group End"; break;
                case 0x23: ret = "Jump relative"; break;
                case 0x24: ret = "Loop Start"; break;
                case 0x25: ret = "Loop End"; break;
                case 0x26: ret = "Call Sequence"; break;
                case 0x27: ret = "Return from Sequence"; break;
                case 0x2A: ret = "Stop tape"; break;
                case 0x33: ret = "Hardware Info"; break;
                case 0x30: ret = "Description"; break;
                case 0x31: ret = "Message"; break;
                case 0x32: ret = "Archive Info"; break;
                case 0x34: ret = "Emulation info"; break;
                case 0x35: ret = "Custom info"; break;
                case 0x40: ret = "Snapshot"; break;
                case 0x5A: ret = "ZXTape!"; break;
                default: ret = "Unknown block";
            }
        }
        return ret;
    }
